...
<div class="baloon">
    <form method="post" id="upd_form" enctype="multipart/form-data" action="{{route('users.update', ['user' => $user])}}">
        @csrf
        @method('put')
        <h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <div class="mb-3 row">
                        <img id="imgPhoto" src="{{URL::route('users.avatar.download',['user'=>$user])}}" class="w-75 m-2">
                    </div>
                    <div class="mb-3 row">
                        <label for="login" class="col12 col-form-label">Обрати новий</label>
                        <div class="col-12">
                ...
                <div class="col-8">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="login" id="login" value="{{$user->user_name}}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="lastname" class="col-sm-4 col-form-label">Прізвище</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="lastname" id="lastname" value="{{$user->userable->lastname}}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="firstname" class="col-sm-4 col-form-label">Ім'я</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="firstname" id="firstname" value="{{$user->userable->firstname}}" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="secondname" class="col-sm-4 col-form-label">По-батькові</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="secondname" id="secondname" value="{{$user->userable->secondname}}" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="status" {{$user->status?'checked="checked"':''}}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" multiple size="10" name="roles[]" id="selectPlan" require>
                                ...
                                <option value="{{$k}}" {{in_array($k,$user->roles_ar)?'selected="selected"':''}}>{{$v}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
