...
@section('content')
    <div class="container">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="reg_number" name="reg_number" type="text" class="form-control" value="{{ $employee->reg_number }}"
                    required="required">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <select id="gender" name="gender" class="form-select">
                    ...
                    <option value="-1" {{ $employee->gender != 1 && $employee->gender != 0 ? 'selected' : '' }}>Немає даних
                    </option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <textarea id="languages" name="languages" cols="40" rows="3" class="form-control"
                    aria-describedby="languagesHelpBlock" required="required">
                    {{ $employee->languages }}
                </textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <textarea id="languages" name="languages" cols="40" rows="3" class="form-control"
                    aria-describedby="languagesHelpBlock" disabled="disabled">
                      {{ $employee->message }}
                  </textarea>
            </div>
        </div>
